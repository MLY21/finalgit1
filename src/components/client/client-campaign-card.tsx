...
export function ClientCampaignCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 flex flex-col">
      ...
      <div className={cn(
        "p-4 pb-3",
        campaign.platform === "Meta Ads" && "bg-gradient-to-br from-blue-400 to-blue-500",
        campaign.platform === "Google Ads" && "bg-gradient-to-br from-rose-400 to-rose-500",
        campaign.platform === "TikTok Ads" && "bg-gradient-to-br from-slate-400 to-slate-500"
      )}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-white">{platformLabels[campaign.platform]}</p>
            </div>
          </div>
